...
class MarketDialog extends CancelAndHelpDialog {
    constructor(id) {
        super(id || 'marketDialog');
    ...
    async destinationStep(stepContext) {
        ...
        if (!bookingDetails.destination) {
            return await stepContext.prompt(TEXT_PROMPT, { prompt: 'You entered the market dialog' });
        } else {
...
module.exports.MarketDialog = MarketDialog;
